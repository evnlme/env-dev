...
- What if the pursuit of capital became the cultural norm? How would you approach life with this value? If I had to define capital, I would define it as the potential for production (of things you value hopefully). Intuitively, accumulating more capital leads to higher productive capacities. But that's not necessarily true. Capital is not automatic; capital needs to be orchestrated at some level to be productive. At a certain point of capital accumulation, intentionally delegating someone else to operate personal capital becomes necessary to expand personal productive capacities further. The pursuit of capital should not only be a right but a shared mission.
- Are surpluses inefficient? I value efficiency. When it comes to resources, I tend to take and create only what I need. A surplus means having more than what I need. I think it is inefficient as an individual to expend the extra energy to obtain the extra resources. But what if you are not alone. For many resources, obtaining the extra resources is no more expensive than obtaining the necessary ones per unit. I could obtain a surplus in one resource which I can exchange with a surplus you obtained in another resource. Surpluses can be efficient in the context of specialization. Surpluses are not inherently efficient or inefficient, but it is clear that surplus is a necessary condition for specialization. It is hard to argue that today's technological advancements could be achieved without specialization. We owe today's technological advancements to surpluses. I want to believe that surpluses have positive cultural value. I am not a fan of celebrations, but I understand that many people love them. Surpluses enable celebrations. Love the surplus, not the celebration. You could measure prosperity by asking whether people can generate a surplus for themselves and exchange their surplus with others. What does surplus mean for me? I should take what I need and create more than what I need.
