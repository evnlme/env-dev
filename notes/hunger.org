...
[fn:1] Food doesn't need to look beautiful. As long as it looks like it is meant to be eaten, it's good enough for me. Admittedly, the meaning of "meant to be eaten" relies a lot on personal experience.

[fn:2] Look up advanced glycation end products (AGEs).

[fn:3] I haven't gotten around to testing sugar substitutes. Allulose seems promising. On the other hand, sucralose and aspartame are dangerous. When I learned that sucralose disrupted the microbiome, I stopped eating my sucralose sweetened whey protein powder.

[fn:4] Glyphosate is used to desiccate wheat for harvest. I haven't gotten around to using the organic varieties that don't use glyphosate.
